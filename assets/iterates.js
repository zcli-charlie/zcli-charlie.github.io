...
function genIterDiagram(f, xstar, axis) {
  ...
  */
  ...
  function renderIterates(div) {
    ...
    var circ = svg.append("g") //use xlink:href="cafe-18.svg#svg4619">
      ...
      .call(d3.drag().on("drag", function() {
        ...
        w0 = [x,y]
        onDrag(w0)
        iter(state_alpha, state_beta, state_lambda, w0);
      }))
    ...
    function iter(alpha, beta, lambda, w0) {
      ...
      var OW = runMomentum(f, w0, alpha, beta, lambda, totalIters)
      var W = OW[1]
    ...
    return { control:iter,
             ...
             lambda: function() {return state_lamda} }
  }
  ...
  renderIterates.lambda = function (_) {
    state_lambda = _; return renderIterates;
  }
